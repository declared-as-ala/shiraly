...
export const dictionaries = {
  fr: {
    ...
    cart: {
      ...
      promoInvalid: 'Ce code promo est invalide.',
      promoExpired: 'Ce code promo a expiré.',
      promoNotYetActive: "Ce code promo n'est pas encore actif.",
      promoMinOrder: 'Le montant minimum de commande n\'est pas atteint.',
      promoUsageLimit: 'Ce code promo a atteint sa limite d\'utilisation.',
      promoNotApplicable: 'Ce code ne s\'applique pas aux articles de votre panier.',
      promoRemoved: 'Code promo retiré.',
      promoLoading: 'Vérification…',
      promoSaving: '…',
    },
    contact: {
  ...
  ar: {
    ...
    cart: {
      ...
      promoInvalid: 'هذا الرمز الترويجي غير صالح.',
      promoExpired: 'انتهت صلاحية هذا الرمز الترويجي.',
      promoNotYetActive: 'هذا الرمز الترويجي غير نشط بعد.',
      promoMinOrder: 'لم يتم الوصول إلى الحد الأدنى للطلب.',
      promoUsageLimit: 'وصل هذا الرمز الترويجي إلى الحد الأقصى للاستخدام.',
      promoNotApplicable: 'هذا الرمز لا ينطبق على منتجات سلتك.',
      promoRemoved: 'تم إزالة الرمز الترويجي.',
      promoLoading: 'جارٍ التحقق…',
      promoSaving: '…',
    },
    contact: {
      title: 'اتصل بنا',
